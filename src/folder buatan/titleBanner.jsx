const TitleBanner = () => {
    return (
                <div className="w-full h-99 bg-gray-700 flex">
                    ...
                    <div className="flex">
                    <h1 className="text-white text-3xl font-bold pl-7 pt-15">Unleash Your Creativity</h1>
                    <img 
...
/>
                ...
                <h1 className="text-red-500 text-3xl font-bold pl-7 pt-3">Right Now</h1>
                ...
                <a href="#" className="mt-2 inline-block bg-red-500 text-white py-2 px-4 rounded 
                    ...
                    <div className="w-2/5 h-99 pl-25 flex items-center justify-around">
                    <div>
                        <h1 className="text-white text-2xl font-bold">2,245,396</h1>
                        <h1 className="text-white text-2xl font-bold">2,245,396</h1>
                    </div>
                    <div>
                    <h1 className="text-white text-2xl font-bold">2,245,396</h1>
